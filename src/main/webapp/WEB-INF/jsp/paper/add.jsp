					...
					<div class="row">
						<div class="col-xs-12">
							<form:form name="form" method="post" class="form-horizontal"
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">是否练习：</label>
									<div class="col-sm-5 input-group">
										<label> <input type="checkbox" name="practice"
											id="practice" class="ace ace-switch ace-switch-4 btn-flat"
											<c:if test="${examPaper.isPractice==1}">checked="checked"</c:if>>
											<span class="lbl"></span></label>
									</div>
									<form:errors path="isPractice"
										cssClass="label label-xlg label-danger">
									</form:errors>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5 input-group">
										<label> <input type="checkbox" name="current"
											id="current" class="ace ace-switch ace-switch-4 btn-flat"
											<c:if test="${examPaper.currentPaper==1}">checked="checked"</c:if>>
											<span class="lbl"></span></label>
									</div>
									<form:errors path="currentPaper"
										cssClass="label label-xlg label-danger">
									</form:errors>
								</div>
